...
return [
    ...
    */
    ...
    /*
    | datafeedcl's REST API (GET /api/assets/{symbol}/ticks?limit=N for
    | recent ticks). Called live, on demand, by
    | app/Services/DataFeedClService.php — no caching or background daemon,
