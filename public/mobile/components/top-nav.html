<nav
  class="flex justify-between items-center p-4 bg-gray-900/95 backdrop-blur-sm"
  role="navigation"
...
>
  <div class="flex items-center space-x-3">
    ...
    <button class="relative" aria-label="Profile status">
      <svg
        class="w-12 h-12 bg-gray-700 rounded-full border-2 border-green-500"
      ...
      <svg
        class="w-3 h-3 bg-green-500 rounded-full absolute top-0 right-0"
        viewBox="0 0 24 24"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
    ...
    <!-- Percentage -->
    <div
      class="bg-gray-800 px-2 py-1 rounded-full border-2 border-green-500 text-xs hover:bg-gray-700 transition-colors cursor-pointer flex items-center justify-center w-12 h-12"
    >
      25%
    </div>
  </div>
  ...
  <div class="flex items-center gap-2 relative">
    <!-- Gift Icon -->
    <button
      class="bg-gray-800 p-2 rounded-md hover:bg-gray-700 transition-colors"
    ...
    >
      ...
      >
        <g id="SVGRepo_iconCarrier">
          ...
          ></path>
          <path
            d="M849.7 421.1v103.1H630.9c-10.4-12.5-35-32.7-89.7-42.3 69.7-12.4 90.7-41.9 95.5-50.6h211.6v-10.1h1.4z"
            fill="#D05C86"
          ></path>
          <path
            d="M849.7 145.3v275.9H640.8c5.4-17.3 2.6-35.9-7.9-51.3-11.6-16.9-31.1-27.1-53.4-28.8V145.3h270.2z"
            fill="#A5EFEB"
          ></path>
        </g>
      </svg>
    ...
    <div class="flex relative">
      ...
      <!-- Wallet button -->
      <button
        class="bg-green-600 p-2 rounded-md hover:bg-green-700 transition-colors"
      ...
      <!-- Wallet Modal -->
      <div id="walletModal" class="hidden fixed inset-0 z-50 right-0">
        <div
          class="fixed right-2 top-7 mt-10 transform w-80 bg-gray-800 rounded-lg shadow-xl z-50"
        >
          <div class="flex justify-between items-center p-4">
            <h2 class="text-lg font-semibold">Quick account top-up</h2>
          ...
          <div class="px-6 pb-6 pt-1 bg-gray-800 text-white">
            ...
            <div class="relative mt-1">
              <select
                class="w-full bg-gray-700 border border-gray-600 rounded-md p-2 focus:ring focus:ring-green-500 text-white"
              >
                <option>Tether (USDT) TRC-20</option>
              </select>
            </div>

            <label class="block text-sm font-medium text-gray-300 mt-4"
              >Amount</label
            >
            <div class="relative mt-1 flex items-center">
              <input
                ...
                value="45400"
              />
              <span class="absolute right-3 text-gray-400">₦</span>
            </div>
            ...
            <div class="flex items-center mt-4">
              ...
              />
              <label for="promo" class="ml-2 text-sm text-gray-300"
            ...
            <button
              class="w-full bg-green-600 text-white py-2 rounded-md mt-4 hover:bg-green-700 transition"
            >
              Continue and pay ₦<span id="amountDisplay">45,400</span>
            </button>
          </div>
        </div>
      </div>
        ...
        >
          <div class="p-2 rounded-lg w-full" style="background: #1f2536">
            <div class="flex items-center justify-between">
              ...
              <p
                class="px-3 py-1 text-sm rounded border-2 border-dotted border-blue-700"
              >
                NGN
              </p>
            </div>
            ...
            <div class="mt-3 flex items-center gap-2">
              ...
              <div class="w-2/5 flex items-center gap-2">
                <button
                  class="font-light text-sm py-1 w-full flex items-center justify-center rounded-md"
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-2">
                ...
                >
                  ...
                  ></path>
                  <path
                    d="M5 20H10V21C10 21.5523 9.55228 22 9 22H6C5.44772 22 5 21.5523 5 21V20Z"
                    fill="currentColor"
                  ></path>
                  <path
                    d="M14 20H19V21C19 21.5523 18.5523 22 18 22H15C14.4477 22 14 21.5523 14 21V20Z"
                    fill="currentColor"
                  ></path>
                </svg>
      ...
      <!-- sercrifice -->
      <!-- <div id="dropModal" class="hiddn fixed inset-0 z-50 right-0">
        <div
