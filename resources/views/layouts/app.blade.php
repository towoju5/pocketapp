    ...
    <body>
        ...
        <script>
            ...
            window.Echo.private('chat.' + "{{ auth()->id() }}")
                ...
                function toggleTradeMenu(button, state) {
                    const container = button.closest('div').parentElement;

                    const openTabs = container.querySelectorAll('.trade-open-close');
                    const indicators = container.querySelectorAll('.tab-indicator');
                    const openContent = container.querySelector('.trade-open-content');
                    const closedContent = container.querySelector('.trade-closed-content');
