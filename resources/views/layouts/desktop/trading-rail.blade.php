<div class="relative flex-shrink-0">
    <div class="w-[84px] h-full bg-[#171e33] border-r border-[#2a3350] flex flex-col items-center py-3 overflow-y-auto box-border">
        <div class="flex flex-col items-center gap-1 w-full">
            ...
            <a href="{{ route('chatify') }}" class="rail-nav-btn" data-nav="chat" style="background:#1c243c;border:1px solid #2a3350;border-radius:8px;padding:8px 4px;width:58px;display:flex;flex-direction:column;align-items:center;gap:4px;font-size:9.5px;font-weight:700;color:#7c86a3;text-decoration:none;margin-bottom:4px;">
    ...
    <div id="navFlyout" class="hidden absolute top-0 left-[84px] z-30 w-[260px] h-full bg-[#171e33] border-r border-[#2a3350]" style="box-shadow:0 20px 60px rgba(0,0,0,0.4);">
