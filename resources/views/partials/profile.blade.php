<ul>
    <li class="flex gap-4 uppercase text-white my-3">
        <a class="py-2 px-6 rounded shadow-md @if(Route::is('deposit.create')) bg-[#434858] @else bg-gray-900 @endif" href="{{ route('deposit.create') }}">Trading Profile</a>

        <a class="py-2 px-6 rounded shadow-md @if(Route::is('payout.create')) bg-[#434858] @else bg-gray-900 @endif" href="{{ route('payout.create') }}">Profile</a>
