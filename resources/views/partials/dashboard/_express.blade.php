...
<div class="grid grid-cols-3 border-b border-[#2a3142]">
    <button onclick="toggleTradeMenu(this, 'new'); $('#CRYPTO_OTC_btn').click()" id="openExpressTradeBtn" class="trade-open-close relative py-2 text-gray-500 bg-[#1e2131] font-thin text-sm active-tab">
        New
        ...
        <div class="text-white">
            <div class="h-full overflow-hidden">
                ...
                <div id="express-new" class="content active">
                    ...
                    {{-- ############  TYPE FILTER ############ --}}
                    <div class="mt-4 grid grid-cols-4 gap-3" id="asset-filters">
                        <button  onclick="toggleTradeMenu(this, 'CRYPTO_OTC');" id="CRYPTO_OTC_btn" class="trade-open-close border border-gray-600 hover:border-blue-600 rounded-md py-2 active" data-filter="CRYPTO_OTC">
                            <i class="fa fa-usd"></i>
                        </button>
                        <button  onclick="toggleTradeMenu(this, 'FOREX_OTC')" class="trade-open-close border border-gray-600 hover:border-blue-600 rounded-md py-2" data-filter="FOREX_OTC">
                            <i class="fa fa-tint"></i>
                        </button>
                        <button  onclick="toggleTradeMenu(this, 'STOCKS_OTC')" class="trade-open-close border border-gray-600 hover:border-blue-600 rounded-md py-2" data-filter="STOCKS_OTC">
                            <i class="fa fa-file-text"></i>
                        </button>
                        <button  onclick="toggleTradeMenu(this, 'search')" class="trade-open-close border border-gray-600 hover:border-blue-600 rounded-md py-2" data-filter="search">
                    ...
                    <div id="asset-list" class="mt-4 space-y-3">
                        <div class="trade-tab-content" data-tab="CRYPTO_OTC">
                            @foreach($assets->where('asset_group', 'CRYPTO_OTC') as $asset)
                        ...
                        <div class="trade-tab-content hidden" data-tab="FOREX_OTC">
                            @foreach($assets->where('asset_group', 'FOREX_OTC') as $asset)
                            <div class="asset-item-{{ $asset->id }} asset-item-groups flex items-center justify-between gap-3" data-type="{{ $asset->asset_group }}">
                                {{-- up --}}
                                <button class="trade-btn up asset_{{ $asset->id }}" data-assetId="{{ $asset->id }}" data-percentage="{{ $asset->asset_profit_margin * 100 }}" data-asset="{{ $asset->symbol }}" data-direction="up" data-close-time="30" onclick="selectTrade(this)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" class="trade-btn-up-svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img">
                        ...
                        <div class="trade-tab-content hidden" data-tab="STOCKS_OTC">
                            @foreach($assets->where('asset_group', 'STOCKS_OTC') as $asset)
                            <div class="asset-item-{{ $asset->id }} asset-item-groups flex items-center justify-between gap-3" data-type="{{ $asset->asset_group }}">
                                {{-- up --}}
                                <button class="trade-btn up asset_{{ $asset->id }}" data-assetId="{{ $asset->id }}" data-percentage="{{ $asset->asset_profit_margin * 100 }}" data-asset="{{ $asset->symbol }}" data-direction="up" data-close-time="30" onclick="selectTrade(this)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none" class="trade-btn-up-svg" xmlns:xlink="http://www.w3.org/1999/xlink" role="img">
                        ...
                        <div class="trade-tab-content hidden" data-tab="search">
