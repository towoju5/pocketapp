...
@section('title', 'Express Trades')

@section('content')
    <x-page-header title="Express Trades" subtitle="Oversight of all express trades platform-wide.">
        <x-slot:actions>
            ...
            <tbody>
                @forelse ($trades as $trade)
                    <tr>
                        ...
                        <td class="font-medium">{{ $trade->asset->symbol ?? $trade->trade_currency }}</td>
                        <td>
