    ...
    <div class="panel box-border personal-info-panel mb-3">
        ...
        <div class="panel-body">
            <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
                <div class="overflow-x-auto text-gray-700 p-6">
                    <form id="change-password-form">
                        ...
                        <div class="space-y-4 mb-6">
                            <div class="flex justify-between items-center flex gap-6">
                                <label for="current-password" class="text-gray-600 whitespace-nowrap">Current Password</label>
                                <div class="w-full">
                        ...
                        <div class="space-y-4 mb-6">
                            <div class="flex justify-between items-center flex gap-6">
                                <label for="new-password" class="text-gray-600 whitespace-nowrap">New Password</label>
                                <div class="w-full">
                        ...
                        <div class="space-y-4 mb-6">
                            <div class="flex justify-between items-center flex gap-6">
                                <label for="confirm-password" class="text-gray-600 whitespace-nowrap">Confirm New Password</label>
                                <div class="w-full">
