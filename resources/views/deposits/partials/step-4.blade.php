    ...
    <div class="bg-gray-800 rounded-lg p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center">
                <img src="//pocketoption.com/images/payments/logo2/usdt-trc20.webp" alt="USDT" class="h-12 mr-4">
                <div>
                    <h2 class="text-lg font-semibold">Tether (USDT) TRC-20</h2>
        ...
        <div class="bg-gray-700 rounded-lg p-4 border border-orange-500 mb-6">
            <h3 class="text-orange-400 font-semibold mb-2">In order to get your Tether (USDT) TRC-20 payment processed automatically:</h3>
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" id="amount" value="$150" readonly class="w-full bg-gray-700 text-white p-3 rounded-lg border border-gray-600">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" id="wallet-address" value="TYP4M3tnDydpUSufVmXE8CnhiznRvAxe94" readonly class="w-full bg-gray-700 text-white p-3 rounded-lg border border-gray-600">
                    <button class="absolute right-3 top-2 bg-teal-500 text-white px-3 py-1 rounded-lg hover:bg-teal-600">
                        Copy
                    </button>
                </div>
